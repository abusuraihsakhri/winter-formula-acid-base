"""
Automated Pytest for winter-formula-acid-base Enrichment Modules.
"""
import sys
...
from enrichment import (
    MetabolicAcidbaseVisualizationEngine,
    ...
    WinterformulaacidbaseEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = WinterformulaacidbaseEnrichmentSuite()
